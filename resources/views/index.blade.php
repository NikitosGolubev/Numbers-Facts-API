...
<head>
    <meta charset="UTF-8" />
    <title>Numbers & Facts API by NikitosGolubev</title>
    <link href="node_modules/bootstrap/dist/css/bootstrap-grid.min.css" rel="stylesheet" type='text/css' />
    <link href="app/css/main/main.css" rel="stylesheet" type='text/css' />
...
<body class='page-body'>
    <header class='page-header'>
        ...
        <div class='page-header__github-link'>
        	<a href='#' class='js-target-blank link text_small-sz'>https://github.com/NikitosGolubev</a>
        </div>
    </header>
    <main>
